...
$split_amounts = $_POST['split_total'];
...
if (mysqli_query($link, $sql)) {
    ...
    header("Location: split-add-ave-mem.php?journey_id=$journey_id&split_members=$split_members_string&split_amounts=$split_amounts&split_id=$split_id"); // Redirect to the accounting page
    exit;
} else {
